...
{define: C#dim7 base-fret 1 frets x 4 2 3 2 3}
{define: Dm base-fret 1 frets x x 0 2 1 3}
{define: Dm7 base-fret 1 frets x x 0 2 1 1}
{define: C/E base-fret 1 frets 0 3 2 0 1 0}
{define: Bb base-fret 1 frets x 1 3 3 3 1}
{define: F2 base-fret 1 frets x x 3 0 1 1}
{define: C2/E base-fret 1 frets 0 3 2 0 3 3}
{define: G7/B base-fret 1 frets x 2 3 0 3 3}
{define: Bbm6 base-fret 1 frets x 1 3 0 2 1}
{define: F/A base-fret 1 frets x 0 3 2 1 1}
{define: G13 base-fret 1 frets 3 2 3 0 0 0}
{define: Dm11 base-fret 3 frets x 3 1 3 1 1}
{define: Dm/C base-fret 1 frets x 3 0 2 3 1}
{define: A7(#9) base-fret 3 frets 3 2 3 3 3 3}
{define: Dm7/C base-fret 1 frets x 3 x 2 1 1}
{define: Bb2 base-fret 1 frets x 1 3 3 1 1}
{define: C/Bb base-fret 1 frets x 1 2 0 1 0}
{define: F/Bb base-fret 1 frets x 1 3 2 1 1}
{define: Bbma7 base-fret 1 frets x 1 3 2 3 1}
{define: F13 base-fret 1 frets 1 0 1 0 3 1}
{define: Ebma7 base-fret 1 frets x x 1 0 3 3}
{define: Bbma9 base-fret 1 frets x 1 0 2 1 1}
{define: Eb/F base-fret 1 frets 1 1 1 3 4 3}
{define: Dm9 base-fret 2 frets x 4 2 1 2 0}
{define: Cm7 base-fret 1 frets x 3 1 3 1 3}
{define: Eb/Db base-fret 1 frets x 4 1 3 4 3}
{define: C7/E base-fret 1 frets 0 3 2 3 1 0}`.substring(1);